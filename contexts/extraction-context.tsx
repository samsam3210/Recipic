    ...
    if (duplicateInfo.type === 'saved' && duplicateInfo.recipeId) {
      ...
      const previewData = {
        ...
        videoInfo: {
          ...
          channelId: duplicateInfo.recentlyViewedData.channelId || '',
          channelUrl: duplicateInfo.recentlyViewedData.channelUrl || '',
          channelThumbnail: duplicateInfo.recentlyViewedData.channelThumbnail || '',
