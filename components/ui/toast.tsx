...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ...
    className={cn(
      ...
      "max-sm:bottom-20 max-sm:top-auto max-sm:left-1/2 max-sm:transform max-sm:-translate-x-1/2 max-sm:w-[90%] max-sm:max-w-[350px]",
      className
    )}
    {...props}
  />
