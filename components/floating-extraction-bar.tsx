...
export function FloatingExtractionBar() {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-4 backdrop-blur-sm">
        {/* Header */}
              ...
              {steps.map((step) => {
                ...
                return (
                  <div key={step.id} className="flex items-center gap-3">
                    <div className={cn(
                      "w-4 h-4 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300",
